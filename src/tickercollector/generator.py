...
def create_price_report_by_av():
    ...
    # It has the format "stock_price_{source}_YYYY-MM-DD_HHMM.csv", where {source} is the data source
    # e.g., "av" for Alpha Vantage, while YYYY-MM-DD is the current date, and HHMM is the current time.
